    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if counter == 1:
                # Get the Data
                modeType = 1
                imgBackground[42:42 + 633, 808:808 + 414] = imgModeList[modeType]
                ...
                ref.child('last_authenticated').set(datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
                ...
                cv2.putText(imgBackground, str(studentInfo['name']), (808 + offset, 445),
                    cv2.FONT_HERSHEY_DUPLEX, 1, (50, 50, 50), 1, cv2.LINE_AA)
