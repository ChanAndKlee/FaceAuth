...
class App:
    ...
    def __init__(self):
        ...
        self.login_btn = tk.Button(self.main_window, image=self.login_btn_img, command = self.login, borderwidth = 0, background = 'white')
...
if __name__ == "__main__":
    app = App()
    app.start()
    # authenticate(encodeListKnown, studentIds)